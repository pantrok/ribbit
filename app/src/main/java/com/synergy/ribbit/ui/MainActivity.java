...
import com.synergy.ribbit.adapters.SectionsPagerAdapter;
            ...
            switch (which) {
                ...
                case 1: //Take video
                    ...
                    if (mMediaUri == null) {
                        ...
                        videoIntent.putExtra(MediaStore.EXTRA_DURATION_LIMIT, 10); // 10 in seconds
                        videoIntent.putExtra(MediaStore.EXTRA_VIDEO_QUALITY, 0); // 0 = Low Quality
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == PICK_PHOTO_REQUEST || requestCode == PICK_VIDEO_REQUEST) {
                ...
                if (PICK_VIDEO_REQUEST == requestCode) {
                    int fileSize = 0;
